...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem('Movie Library', control.setting('library.movie'), 'movies.png', 'DefaultMovies.png', isAction=False)       
        ...
        self.addDirectoryItem('Box Office', 'movies&url=boxoffice', 'oscars.png', 'DefaultFolder.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem('TV Show Library', control.setting('library.tv'), 'movies.png', 'DefaultTVShows.png', isAction=False)
        self.addDirectoryItem('Genres', 'tvGenres', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Selections', 'tvshows&url=rating', 'populars.png', 'DefaultTVShows.png')
        ...
        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem('Trakt/Imdb', 'mytvliteNavigator', 'airing-today.png', 'DefaultVideoPlaylists.png')
